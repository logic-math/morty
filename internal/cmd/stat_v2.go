...
// DisplayStatusV2 displays V2 status in human-readable format.
func (h *StatHandler) DisplayStatusV2(status *state.StatusV2) {
...
// FormatStatusV2AsJSON formats V2 status as JSON string.
func (h *StatHandler) FormatStatusV2AsJSON(status *state.StatusV2) (string, error) {
