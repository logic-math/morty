...
```json
{
  ...
  "context": {
    ...
    "current_job": {
      ...
      "validator": "彐�配置 log_format: json 时，日志输出应为有效的 JSON 格式"
    }
  }
}
```
...
```json
{
  ...
  "context": {
    "completed_jobs_summary": ["call_cli/job_1: 完成 (7 tasks)","call_cli/job_2: 完成 (7 tasks)","call_cli/job_3: 完成 (7 tasks)","call_cli/job_4: 完成 (7 tasks)","call_cli/job_5: 完成 (8 tasks)","call_cli/job_6: 完成 (7 tasks)","call_cli/job_7: 完成 (7 tasks)","cli/job_1: 完成 (8 tasks)","cli/job_2: 完成 (8 tasks)","cli/job_3: 完成 (6 tasks)","config/job_1: 完成 (6 tasks)","config/job_2: 完成 (8 tasks)","config/job_3: 完成 (8 tasks)","config/job_4: 完成 (9 tasks)","deploy/job_1: 完成 (7 tasks)","deploy/job_2: 完成 (7 tasks)","deploy/job_3: 完成 (7 tasks)","deploy/job_4: 完成 (8 tasks)","doing_cmd/job_1: 完成 (7 tasks)","doing_cmd/job_2: 完成 (7 tasks)","doing_cmd/job_3: 完成 (7 tasks)","doing_cmd/job_4: 完成 (7 tasks)","doing_cmd/job_5: 完成 (7 tasks)","errors/job_1: 完成 (7 tasks)","executor/job_1: 完成 (8 tasks)","executor/job_2: 完成 (8 tasks)","executor/job_3: 完成 (8 tasks)","executor/job_4: 完成 (8 tasks)","executor/job_5: 完成 (8 tasks)","executor/job_6: 完成 (8 tasks)","git/job_1: 完成 (8 tasks)","git/job_2: 完成 (7 tasks)","git/job_3: 完成 (9 tasks)","go_env_setup/job_2: 完成 (7 tasks)","go_env_setup/job_3: 完成 (7 tasks)","go_env_setup/job_4: 完成 (5 tasks)","go_env_setup/job_5: 完成 (8 tasks)","logging/job_1: 完成 (8 tasks)","logging/job_2: 完成 (7 tasks)","logging/job_3: 完成 (7 tasks)","logging/job_4: 完成 (7 tasks)","parser/job_1: 完成 (7 tasks)","parser/job_2: 完成 (7 tasks)","parser/job_3: 完成 (6 tasks)","parser/job_4: 完成 (6 tasks)","parser/job_5: 完成 (6 tasks)","parser/job_6: 完成 (8 tasks)","parser/job_7: 完成 (7 tasks)","plan_cmd/job_1: 完成 (8 tasks)","plan_cmd/job_2: 完成 (7 tasks)","plan_cmd/job_3: 完成 (8 tasks)","plan_cmd/job_4: 完成 (8 tasks)","research_cmd/job_1: 完成 (7 tasks)","research_cmd/job_2: 完成 (7 tasks)","research_cmd/job_3: 完成 (6 tasks)","state/job_1: 完成 (8 tasks)","state/job_2: 完成 (8 tasks)","state/job_3: 完成 (9 tasks)"],
    "current_job": {
      "name": "job_6",
      "description": "Job execution",
      "tasks": ["Task 1: 实现 `generateSummary()` 生成摘要","Task 2: 计算执行耗时","Task 3: 统计 Tasks 完成情况","Task 4: 确定下一步操作提示","Task 5: 格式化输出摘要","Task 6: 彩色输出支持","Task 7: 编写单元测试"],
      "dependencies": [],
      "validator": "[ ] 摘要包含模块/Job 名称"
    }
  }
}
```
