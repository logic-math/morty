...
```json
{
  ...
  "context": {
    "completed_jobs_summary": ["call_cli/job_1: 完成 (7 tasks)","call_cli/job_2: 完成 (7 tasks)","call_cli/job_3: 完成 (7 tasks)","call_cli/job_4: 完成 (7 tasks)","call_cli/job_5: 完成 (8 tasks)","call_cli/job_6: 完成 (7 tasks)","call_cli/job_7: 完成 (7 tasks)","cli/job_1: 完成 (8 tasks)","cli/job_2: 完成 (8 tasks)","cli/job_3: 完成 (6 tasks)","config/job_1: 完成 (6 tasks)","config/job_2: 完成 (8 tasks)","config/job_3: 完成 (8 tasks)","config/job_4: 完成 (9 tasks)","deploy/job_1: 完成 (7 tasks)","deploy/job_2: 完成 (7 tasks)","deploy/job_3: 完成 (7 tasks)","deploy/job_4: 完成 (8 tasks)","errors/job_1: 完成 (7 tasks)","executor/job_1: 完成 (8 tasks)","executor/job_2: 完成 (8 tasks)","executor/job_3: 完成 (8 tasks)","executor/job_4: 完成 (8 tasks)","executor/job_5: 完成 (8 tasks)","executor/job_6: 完成 (8 tasks)","git/job_1: 完成 (8 tasks)","git/job_2: 完成 (7 tasks)","git/job_3: 完成 (9 tasks)","go_env_setup/job_2: 完成 (7 tasks)","go_env_setup/job_3: 完成 (7 tasks)","go_env_setup/job_4: 完成 (5 tasks)","go_env_setup/job_5: 完成 (8 tasks)","logging/job_1: 完成 (8 tasks)","logging/job_2: 完成 (7 tasks)","logging/job_3: 完成 (7 tasks)","logging/job_4: 完成 (7 tasks)","parser/job_1: 完成 (7 tasks)","parser/job_2: 完成 (7 tasks)","parser/job_3: 完成 (6 tasks)","parser/job_4: 完成 (6 tasks)","parser/job_5: 完成 (6 tasks)","parser/job_6: 完成 (8 tasks)","parser/job_7: 完成 (7 tasks)","plan_cmd/job_1: 完成 (8 tasks)","plan_cmd/job_2: 完成 (7 tasks)","research_cmd/job_1: 完成 (7 tasks)","research_cmd/job_2: 完成 (7 tasks)","research_cmd/job_3: 完成 (6 tasks)","state/job_1: 完成 (8 tasks)","state/job_2: 完成 (8 tasks)","state/job_3: 完成 (9 tasks)"],
    "current_job": {
      "name": "job_3",
      "description": "Job execution",
      "tasks": ["Task 1: 实现 `loadPlanPrompt() string` 加载系统提示词","Task 2: 实现 `buildClaudeCommand(prompt, facts) []string`","Task 3: 构建包含研究事实的完整提示词","Task 4: 使用 `os/exec` 执行 Claude Code","Task 5: 以 Plan 模式启动 (`--permission-mode plan`)","Task 6: 处理执行错误和退出码","Task 7: 记录执行日志","Task 8: 编写单元测试"],
      "dependencies": [],
      "validator": "[ ] 正确读取 `prompts/plan.md`"
    }
  }
}
```
