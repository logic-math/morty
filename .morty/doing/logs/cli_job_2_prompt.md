...
```json
{
  ...
  "context": {
    "completed_jobs_summary": ["call_cli/job_1: 完成 (7 tasks)","call_cli/job_2: 完成 (7 tasks)","call_cli/job_3: 完成 (7 tasks)","call_cli/job_4: 完成 (7 tasks)","call_cli/job_5: 完成 (8 tasks)","call_cli/job_6: 完成 (7 tasks)","call_cli/job_7: 完成 (7 tasks)","cli/job_1: 完成 (8 tasks)","config/job_1: 完成 (6 tasks)","config/job_2: 完成 (8 tasks)","config/job_3: 完成 (8 tasks)","config/job_4: 完成 (9 tasks)","deploy/job_1: 完成 (7 tasks)","deploy/job_2: 完成 (7 tasks)","deploy/job_3: 完成 (7 tasks)","deploy/job_4: 完成 (8 tasks)","errors/job_1: 完成 (7 tasks)","git/job_1: 完成 (8 tasks)","git/job_2: 完成 (7 tasks)","git/job_3: 完成 (9 tasks)","go_env_setup/job_2: 完成 (7 tasks)","go_env_setup/job_3: 完成 (7 tasks)","go_env_setup/job_4: 完成 (5 tasks)","go_env_setup/job_5: 完成 (8 tasks)","logging/job_1: 完成 (8 tasks)","logging/job_2: 完成 (7 tasks)","logging/job_3: 完成 (7 tasks)","logging/job_4: 完成 (7 tasks)","parser/job_1: 完成 (7 tasks)","parser/job_2: 完成 (7 tasks)","parser/job_3: 完成 (6 tasks)","parser/job_4: 完成 (6 tasks)","parser/job_5: 完成 (6 tasks)","parser/job_6: 完成 (8 tasks)","parser/job_7: 完成 (7 tasks)","state/job_1: 完成 (8 tasks)","state/job_2: 完成 (8 tasks)","state/job_3: 完成 (9 tasks)"],
    "current_job": {
      "name": "job_2",
      "description": "Job execution",
      "tasks": ["Task 1: 创建 `internal/cli/router.go` 文件","Task 2: 实现 `Router` 结构体","Task 3: 实现 `Register(cmd Command) error` 方法","Task 4: 实现 `Execute(ctx context.Context, args []string) error` 方法","Task 5: 实现 `GetHandler(name string) (CommandHandler, bool)` 方法","Task 6: 实现 `ListCommands() []Command` 方法","Task 7: 对未知命令返回友好错误信息","Task 8: 编写单元测试 `router_test.go`"],
      "dependencies": [],
      "validator": "[ ] 注册命令后能通过名称获取 Handler"
    }
  }
}
```
