...
```json
{
  ...
  "context": {
    "completed_jobs_summary": ["call_cli/job_1: 完成 (7 tasks)","call_cli/job_2: 完成 (7 tasks)","call_cli/job_3: 完成 (7 tasks)","call_cli/job_4: 完成 (7 tasks)","call_cli/job_5: 完成 (8 tasks)","call_cli/job_6: 完成 (7 tasks)","call_cli/job_7: 完成 (7 tasks)","config/job_1: 完成 (6 tasks)","config/job_2: 完成 (8 tasks)","config/job_3: 完成 (8 tasks)","config/job_4: 完成 (9 tasks)","deploy/job_1: 完成 (7 tasks)","deploy/job_2: 完成 (7 tasks)","deploy/job_3: 完成 (7 tasks)","deploy/job_4: 完成 (8 tasks)","errors/job_1: 完成 (7 tasks)","git/job_1: 完成 (8 tasks)","git/job_2: 完成 (7 tasks)","git/job_3: 完成 (9 tasks)","go_env_setup/job_2: 完成 (7 tasks)","go_env_setup/job_3: 完成 (7 tasks)","go_env_setup/job_4: 完成 (5 tasks)","go_env_setup/job_5: 完成 (8 tasks)","logging/job_1: 完成 (8 tasks)","logging/job_2: 完成 (7 tasks)","logging/job_3: 完成 (7 tasks)","logging/job_4: 完成 (7 tasks)","parser/job_1: 完成 (7 tasks)","parser/job_2: 完成 (7 tasks)","parser/job_3: 完成 (6 tasks)","parser/job_4: 完成 (6 tasks)","parser/job_5: 完成 (6 tasks)","parser/job_6: 完成 (8 tasks)","parser/job_7: 完成 (7 tasks)","state/job_1: 完成 (8 tasks)"],
    "current_job": {
      "name": "job_2",
      "description": "Job execution",
      "tasks": ["Task 1: 创建 `internal/state/manager.go` 文件结构","Task 2: 实现 `GetJobStatus(module, job string) (Status, error)`","Task 3: 实现 `UpdateJobStatus(module, job string, status Status) error`","Task 4: 实现 `GetCurrent() (*CurrentJob, error)` 获取当前 Job","Task 5: 实现 `SetCurrent(module, job string, status Status) error`","Task 6: 实现 `GetSummary() (*Summary, error)` 获取统计摘要","Task 7: 实现 `GetPendingJobs() []JobRef` 获取待处理 Job 列表","Task 8: 编写单元测试 `manager_test.go`"],
      "dependencies": [],
      "validator": "[ ] 获取存在的 Job 状态返回正确值"
    }
  }
}
```
