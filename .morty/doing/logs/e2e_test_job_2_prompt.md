...
```json
{
  ...
  "context": {
    ...
    "current_job": {
      ...
      "validator": "彠�配置 log_format: json 时，日志输出应为有效的 JSON 格式"
    }
  }
}
```
