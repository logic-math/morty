...
```json
{
  ...
  "context": {
    "completed_jobs_summary": ["call_cli/job_1: 完成 (7 tasks)","call_cli/job_2: 完成 (7 tasks)","call_cli/job_3: 完成 (7 tasks)","call_cli/job_4: 完成 (7 tasks)","call_cli/job_5: 完成 (8 tasks)","call_cli/job_6: 完成 (7 tasks)","call_cli/job_7: 完成 (7 tasks)","cli/job_1: 完成 (8 tasks)","cli/job_2: 完成 (8 tasks)","cli/job_3: 完成 (6 tasks)","config/job_1: 完成 (6 tasks)","config/job_2: 完成 (8 tasks)","config/job_3: 完成 (8 tasks)","config/job_4: 完成 (9 tasks)","deploy/job_1: 完成 (7 tasks)","deploy/job_2: 完成 (7 tasks)","deploy/job_3: 完成 (7 tasks)","deploy/job_4: 完成 (8 tasks)","doing_cmd/job_1: 完成 (7 tasks)","doing_cmd/job_2: 完成 (7 tasks)","doing_cmd/job_3: 完成 (7 tasks)","doing_cmd/job_4: 完成 (7 tasks)","doing_cmd/job_5: 完成 (7 tasks)","doing_cmd/job_6: 完成 (7 tasks)","doing_cmd/job_7: 完成 (7 tasks)","errors/job_1: 完成 (7 tasks)","executor/job_1: 完成 (8 tasks)","executor/job_2: 完成 (8 tasks)","executor/job_3: 完成 (8 tasks)","executor/job_4: 完成 (8 tasks)","executor/job_5: 完成 (8 tasks)","executor/job_6: 完成 (8 tasks)","git/job_1: 完成 (8 tasks)","git/job_2: 完成 (7 tasks)","git/job_3: 完成 (9 tasks)","go_env_setup/job_2: 完成 (7 tasks)","go_env_setup/job_3: 完成 (7 tasks)","go_env_setup/job_4: 完成 (5 tasks)","go_env_setup/job_5: 完成 (8 tasks)","logging/job_1: 完成 (8 tasks)","logging/job_2: 完成 (7 tasks)","logging/job_3: 完成 (7 tasks)","logging/job_4: 完成 (7 tasks)","parser/job_1: 完成 (7 tasks)","parser/job_2: 完成 (7 tasks)","parser/job_3: 完成 (6 tasks)","parser/job_4: 完成 (6 tasks)","parser/job_5: 完成 (6 tasks)","parser/job_6: 完成 (8 tasks)","parser/job_7: 完成 (7 tasks)","plan_cmd/job_1: 完成 (8 tasks)","plan_cmd/job_2: 完成 (7 tasks)","plan_cmd/job_3: 完成 (8 tasks)","plan_cmd/job_4: 完成 (8 tasks)","research_cmd/job_1: 完成 (7 tasks)","research_cmd/job_2: 完成 (7 tasks)","research_cmd/job_3: 完成 (6 tasks)","reset_cmd/job_1: 完成 (7 tasks)","reset_cmd/job_2: 完成 (7 tasks)","reset_cmd/job_3: 完成 (7 tasks)","reset_cmd/job_4: 完成 (8 tasks)","stat_cmd/job_1: 完成 (6 tasks)","stat_cmd/job_2: 完成 (7 tasks)","stat_cmd/job_3: 完成 (6 tasks)","stat_cmd/job_4: 完成 (6 tasks)","stat_cmd/job_5: 完成 (7 tasks)","state/job_1: 完成 (8 tasks)","state/job_2: 完成 (8 tasks)","state/job_3: 完成 (9 tasks)"],
    "current_job": {
      "name": "job_5",
      "description": "Job execution",
      "tasks": ["Task 1: 实现 `syncStatusAfterReset(commit)`","Task 2: 从提交信息解析回滚到的位置","Task 3: 重置该位置之后的所有 Job 为 PENDING","Task 4: 更新 `status.json`","Task 5: 保持回滚位置之前的完成状态","Task 6: 输出当前状态提示","Task 7: 编写单元测试"],
      "dependencies": [],
      "validator": "[ ] 正确解析回滚位置"
    }
  }
