...
```json
{
  ...
  "context": {
    "completed_jobs_summary": ["config/job_1: 完成 (6 tasks)","config/job_2: 完成 (8 tasks)","config/job_3: 完成 (8 tasks)","config/job_4: 完成 (9 tasks)","deploy/job_1: 完成 (7 tasks)","deploy/job_2: 完成 (7 tasks)","deploy/job_3: 完成 (7 tasks)","deploy/job_4: 完成 (8 tasks)","errors/job_1: 完成 (7 tasks)","git/job_1: 完成 (8 tasks)","git/job_2: 完成 (7 tasks)","git/job_3: 完成 (9 tasks)","go_env_setup/job_2: 完成 (7 tasks)","go_env_setup/job_3: 完成 (7 tasks)","go_env_setup/job_4: 完成 (5 tasks)","go_env_setup/job_5: 完成 (8 tasks)","logging/job_1: 完成 (8 tasks)","logging/job_2: 完成 (7 tasks)","logging/job_3: 完成 (7 tasks)","parser/job_1: 完成 (7 tasks)","parser/job_2: 完成 (7 tasks)","parser/job_3: 完成 (6 tasks)","parser/job_4: 完成 (6 tasks)","parser/job_5: 完成 (6 tasks)","parser/job_6: 完成 (8 tasks)","parser/job_7: 完成 (7 tasks)"],
    "current_job": {
      "name": "job_4",
      "description": "Job execution",
      "tasks": ["Task 1: 创建 `internal/logging/format.go` 定义格式相关类型","Task 2: 实现文本格式输出 (人类可读)","Task 3: 实现 JSON 格式输出 (结构化)","Task 4: 实现多输出目标 (控制台 + 文件)","Task 5: 实现根据环境自动选择格式 (开发=文本, 生产=JSON)","Task 6: 配置文件支持设置日志格式和级别","Task 7: 编写单元测试 `format_test.go`"],
      "dependencies": [],
      "validator": "[ ] 文本格式输出包含时间、级别、消息、属性"
    }
  }
}
```
