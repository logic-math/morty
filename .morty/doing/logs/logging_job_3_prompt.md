...
```json
{
  ...
  "context": {
    "completed_jobs_summary": ["config/job_1: 完成 (6 tasks)","config/job_2: 完成 (8 tasks)","config/job_3: 完成 (8 tasks)","config/job_4: 完成 (9 tasks)","deploy/job_1: 完成 (7 tasks)","deploy/job_2: 完成 (7 tasks)","deploy/job_3: 完成 (7 tasks)","deploy/job_4: 完成 (8 tasks)","errors/job_1: 完成 (7 tasks)","git/job_1: 完成 (8 tasks)","git/job_2: 完成 (7 tasks)","git/job_3: 完成 (9 tasks)","go_env_setup/job_2: 完成 (7 tasks)","go_env_setup/job_3: 完成 (7 tasks)","go_env_setup/job_4: 完成 (5 tasks)","go_env_setup/job_5: 完成 (8 tasks)","logging/job_1: 完成 (8 tasks)","logging/job_2: 完成 (7 tasks)","parser/job_1: 完成 (7 tasks)","parser/job_2: 完成 (7 tasks)","parser/job_3: 完成 (6 tasks)","parser/job_4: 完成 (6 tasks)","parser/job_5: 完成 (6 tasks)","parser/job_6: 完成 (8 tasks)","parser/job_7: 完成 (7 tasks)"],
    "current_job": {
      "name": "job_3",
      "description": "Job execution",
      "tasks": ["Task 1: 创建 `internal/logging/job_logger.go` 文件结构","Task 2: 实现 `JobLogger` 结构体，包含 module 和 job 字段","Task 3: 实现 Job 开始/结束日志自动记录","Task 4: 实现 Task 级别的日志记录","Task 5: 支持从 JobLogger 获取标准 Logger 接口","Task 6: 实现日志文件按 Job 分离 (可选)","Task 7: 编写单元测试 `job_logger_test.go`"],
      "dependencies": [],
      "validator": "[ ] JobLogger 正确记录 module 和 job 信息"
    }
  }
}
```
