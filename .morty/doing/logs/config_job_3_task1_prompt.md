...
**Job**: job_3
**当前 Task**: #1
**Task 描述**: 实现 `config_check_research_exists()`

## 任务列表

- [ ] 实现 `config_check_research_exists()`\n- [ ] 实现 `config_check_plan_done()`\n- [ ] 实现 `config_require_plan()`\n- [ ] 实现 `config_load_research_facts()`\n- [ ] 定义前置条件检查的错误提示信息\n
...
2. 执行当前 Task: 实现 `config_check_research_exists()`
3. 如有问题，记录 debug_log
4. 更新状态文件
5. 输出 RALPH_STATUS
