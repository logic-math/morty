...
```json
{
  ...
  "context": {
    "completed_jobs_summary": ["config/job_1: 完成 (6 tasks)","config/job_2: 完成 (8 tasks)","config/job_3: 完成 (8 tasks)","config/job_4: 完成 (9 tasks)","deploy/job_1: 完成 (7 tasks)","deploy/job_2: 完成 (7 tasks)","deploy/job_3: 完成 (7 tasks)","deploy/job_4: 完成 (8 tasks)","errors/job_1: 完成 (7 tasks)","git/job_1: 完成 (8 tasks)","git/job_2: 完成 (7 tasks)","git/job_3: 完成 (9 tasks)","go_env_setup/job_2: 完成 (7 tasks)","go_env_setup/job_3: 完成 (7 tasks)","go_env_setup/job_4: 完成 (5 tasks)","go_env_setup/job_5: 完成 (8 tasks)","logging/job_1: 完成 (8 tasks)","parser/job_1: 完成 (7 tasks)","parser/job_2: 完成 (7 tasks)","parser/job_3: 完成 (6 tasks)","parser/job_4: 完成 (6 tasks)","parser/job_5: 完成 (6 tasks)","parser/job_6: 完成 (8 tasks)","parser/job_7: 完成 (7 tasks)"],
    "current_job": {
      "name": "job_2",
      "description": "Job execution",
      "tasks": ["Task 1: 创建 `internal/logging/rotator.go` 文件结构","Task 2: 实现 `ShouldRotate(logFile string) bool` 检查文件大小","Task 3: 实现 `Rotate(logFile string) error` 执行轮转","Task 4: 实现标准轮转模式 (morty.log → morty.log.1 → ...)","Task 5: 实现旧日志 gzip 压缩 (保留最近 5 个)","Task 6: 实现清理过期日志文件","Task 7: 编写单元测试 `rotator_test.go`"],
      "dependencies": [],
      "validator": "[ ] 小文件 (50 bytes < max 100 bytes) 不触发轮转"
    }
  }
}
```
